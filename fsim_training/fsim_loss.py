...
class FSIM_EDMLoss:
    def __init__(self, P_mean=-1.2, P_std=1.2, sigma_data=0.5,beta_d=19.9, beta_min=0.1):
        ...
        ### EDM doesn't have beta_d and beta_min
        ### beta_d is the weight of the discriminator loss
        ### beta_min is the minimum weight of the discriminator loss
        
    def generator_share_encoder_loss(self, true_score, fake_score, images, labels=None, augment_pipe=None,tmax = 800,return_y_D=True):
        ...
        loss = (y_real-y_fake)*(y_fake-y)/weight_factor 
    ...
    def generator_loss(self, true_score, fake_score, images, labels=None, augment_pipe=None,tmax = 800):
